...
public class ContentCommon {
	...
	public static final String APPRE_KEY = "testsssss";
	
	public static final String XG_ACCESSID = "2100283404";
	
	public static final String XG_SECRETKEY ="6b90356a3e58eec36985380b2ce68370";
	
	public static  String XG_TOKEN ="";
 
	public static final String YB_SecretKey = "sec-O1UOmFNaTUhwyJ9Zyi93ifUxn2UJbhfECPKUJIebEguuFZne";
	
	public static final String YB_APPKEY ="59bf9b2379b63c6f6445af1c";
	 
	public static String YB_Alias = "";
	...
	public static final String XM_APP_KEY = "5241753771258";//baoming
	public static final String XM_PACKAGE_NAME = "shix.ihdbell.project";//baoming
	...
	public static final int MSG_GET_RESET_LOGS = 0x3c;
	public static final String SDCARD_PATH = "iHDBell";
	...
	public static final int MSG_TYPE_GET_PUSH_STATE = 0x40;
