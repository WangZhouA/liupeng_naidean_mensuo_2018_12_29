...
public class SetUnlockPwdActivityModel extends BaseModel {
    public void setUnlockPwd(final int code, Map param, final OnLoadHttpDataListener listener){
        HttpDataDevice.getInstance().setUnlockPwd(param, new Observer<MdlBaseHttpResp>() {
            @Override
