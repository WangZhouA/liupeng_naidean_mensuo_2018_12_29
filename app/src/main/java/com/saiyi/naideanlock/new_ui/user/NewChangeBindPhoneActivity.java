...
public class NewChangeBindPhoneActivity extends MVPBaseActivity<ChangeBindPhoneActivityView, ChangeBindPhoneActivityPresenter> implements ChangeBindPhoneActivityView {
    ...
    private void clickCheck() {
        ...
        params.put("oldCode", phoneCheckCode);
        params.put("oldPassword", Utility.Md5(pwd));
    ...
    private void clickUpdate() {
        ...
        Map<String, String> params = new HashMap<>();
        params.put("newCode", phoneCheckCode);
        params.put("oldNumber", MyApplication.getInstance().mdlUserInApp.phone);
        params.put("newNumber", phone);
        presenter.updatePhone(params);
    }
