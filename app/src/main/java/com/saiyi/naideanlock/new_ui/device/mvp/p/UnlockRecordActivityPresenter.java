...
public class UnlockRecordActivityPresenter extends BasePresenter<UnlockRecordActivityView> {
    ...
    public void getUnlockRecord(Map map) {
        if (model != null) {
            view.showLoading();
            model.getUnlockRecord(REQ_GET_LIST, map, this);
        }
    }

    public void deleteAllUnlockRecord(Map map) {
        if (model != null) {
            view.showLoading();
            model.deleteAllUnlockRecord(REQ_DEL, map, this);
        }
    }
