...
public class NewSettingActivity extends MVPBaseActivity<SettingActivityView, SettingActivityPresenter> implements SettingActivityView {
    ...
    protected void initViewAndControl() {
        ...
        setting_unmanned_mode_cb.setSelected(EnumSwitch.ON.equals(mdlDevice.no));
        setting_tamper_cb.setSelected(EnumSwitch.ON.equals(mdlDevice.prying));
        setting_no_power_cb.setSelected(EnumSwitch.ON.equals(mdlDevice.low));
