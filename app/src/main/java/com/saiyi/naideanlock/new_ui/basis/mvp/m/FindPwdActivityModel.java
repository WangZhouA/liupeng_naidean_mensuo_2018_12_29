...
public class FindPwdActivityModel extends BaseModel {
    public void findPwd(final int code, Map param, final OnLoadHttpDataListener listener){
        HttpDataBasis.getInstance().findPwd(param, new Observer<MdlBaseHttpResp>() {
            @Override
            public void onSubscribe(Disposable d) {
                FindPwdActivityModel.this.disposable = d;
            }
