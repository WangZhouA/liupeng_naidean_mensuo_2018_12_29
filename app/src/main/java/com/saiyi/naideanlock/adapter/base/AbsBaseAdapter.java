package com.saiyi.naideanlock.adapter.base;
...
public abstract class AbsBaseAdapter<T,VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH>{
    ...
    public void onBindViewHolder(VH holder, int position) {
        onBindDataForItem(holder,mData.get(position),position,mData);
     ...
     * @param position 位置
     */
    public abstract void onBindDataForItem(VH viewHolder,T bean,int position,List<T> mData);
